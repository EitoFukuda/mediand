...
>
    ...
    <div class="store-hero__content">
        <div class="container">
            <div class="store-hero__main-info store-hero__main-info--bottom-left">
                ...
                foreach ($hero_sns_definitions as $sns_key => $sns_item) {
                    if (get_field($sns_item['field'], $store_id)) {
                        ...
                        <a href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener noreferrer" 
                           class="store-hero__social-link store-hero__social-link--enhanced" 
                           title="<?php echo esc_attr($sns_item['alt']); ?>" 
                           data-sns="<?php echo esc_attr($sns_key); ?>">
                            <span class="social-link-bg"></span>
                            <img src="<?php echo esc_url($icon_base_path . $sns_item['icon']); ?>" 
                                 alt="<?php echo esc_attr($sns_item['alt']); ?>" 
                                 class="store-hero__social-icon">
                            <span class="social-link-ripple"></span>
                        </a>
                        <?php
                    }
                }
                ...
                if ($has_sns_hero) : ?>
                    <div class="store-hero__social store-hero__social--enhanced">
