...
(function($) {
    ...
    const config = {
        ...
        // 色のパレット（コンセプトカラー）
        colors: [
            'rgba(232, 180, 232, 0.2)',  // 薄い紫
            'rgba(199, 125, 199, 0.16)', // ミディアム紫
            'rgba(221, 160, 221, 0.24)', // ライト紫
            'rgba(155, 89, 182, 0.12)',  // ディープ紫
            'rgba(230, 126, 200, 0.18)', // ピンク紫
            'rgba(186, 85, 211, 0.14)'   // バイオレット
        ],
        // サイズ範囲
        sizeRange: {
            min: 40,
